...
const (
	Region_List_FullMethodName         = "/grpc_sdk.region.Region/List"
	Region_ManualUpdate_FullMethodName = "/grpc_sdk.region.Region/ManualUpdate"
)
...
func (c *regionClient) ManualUpdate(ctx context.Context, in *common.EmptyRequest, opts ...grpc.CallOption) (*common.EmptyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Region_ManualUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Region_ManualUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Region_ManualUpdate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
