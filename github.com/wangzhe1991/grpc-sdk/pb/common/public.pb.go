...
type SFID struct {
	...
	Sfid int64 `protobuf:"varint,1,opt,name=sfid,proto3" json:"sfid,omitempty"`
}
...
func (x *SFID) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SFID) ProtoMessage() {}

func (x *SFID) ProtoReflect() protoreflect.Message {
	mi := &file_public_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SFID.ProtoReflect.Descriptor instead.
func (*SFID) Descriptor() ([]byte, []int) {
	return file_public_proto_rawDescGZIP(), []int{3}
}

func (x *SFID) GetSfid() int64 {
	if x != nil {
		return x.Sfid
	}
	return 0
...
func (x *ListRequest) GetIsAll() bool {
	if x != nil {
		return x.IsAll
	}
	return false
...
var file_public_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x70, 0x63, 0x5f, 0x73, 0x64, 0x6b, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22,
	...
	0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x1a, 0x0a, 0x04, 0x53, 0x46, 0x49, 0x44, 0x12, 0x12,
	0x0a, 0x04, 0x73, 0x66, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x66,
	0x69, 0x64, 0x22, 0xb4, 0x01, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x69, 0x73, 0x5f, 0x61, 0x6c, 0x6c, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x05, 0x69, 0x73, 0x41, 0x6c, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x67,
	...
	0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61, 0x6e, 0x67, 0x7a, 0x68, 0x65, 0x31,
	0x39, 0x39, 0x31, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x70, 0x62, 0x2f,
...
var file_public_proto_goTypes = []interface{}{
	(*EmptyRequest)(nil),  // 0: grpc_sdk.common.EmptyRequest
	(*EmptyResponse)(nil), // 1: grpc_sdk.common.EmptyResponse
	(*ID)(nil),            // 2: grpc_sdk.common.ID
	(*SFID)(nil),          // 3: grpc_sdk.common.SFID
	(*ListRequest)(nil),   // 4: grpc_sdk.common.ListRequest
}
